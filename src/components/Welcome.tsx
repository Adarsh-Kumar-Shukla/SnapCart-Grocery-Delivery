...
const Welcome = ({nextStep}:propType) => {
  return (
    <div className='flex flex-col items-center justify-center min-h-screen text-center p-6 bg-linear-to-b from-green-50 to-white'>
      ...
      >
        <ShoppingBasket className='text-green-700 h-4 w-4 md:h-8 md:w-8' />
      ...
      <motion.button
        ...
        className='inline-flex items-center gap-2 bg-green-600 hover:bg-green-700 text-white font-semibold py-3 px-8 rounded-2xl shadow-md transition-all duration-200 mt-4'
        onClick={()=>nextStep(2)}
      >
        Next
        <ArrowRight/>
