  ...
  return (
    ...
    bg-white relative'>
      ...
      >
        ...
        className='text-gray-600 mt-6 text-sm flex items-center gap-1 cursor-pointer' onClick={()=>router.push("/register")}>Want to an account ?<LogIn className='w-4 h-4'/> <span className='text-green-700 text-md'>Sign up</span></motion.p>
    </div>
  )
}
